...
class joke:
    ...
    async def praise(self, ctx,):
        ...
        gifs = ['https://i.imgur.com/Qo8KipS.gif',
                ...
                'https://media1.tenor.com/images/27b4d0102ce4f843a2a8c241cff421de/tenor.gif',
    ...
    async def potato(self, ctx,):
        ...
        gifs = ['https://media0.giphy.com/media/U1rlk8zdcAwbm/giphy.gif',
                ...
                'https://media1.tenor.com/images/8252b26bea33c12da5a28605176493a4/tenor.gif?itemid=7672866',
